...
;$(function(){function a(){var a=$("input[name='amy_value_id[]']").serializeArray();return 0==a.length?($(".large-check-block_label").append('<span class="error">Please select at least one value.</span>'),!1):void $(".large-check-block_label .error").remove()}$("#js-amy-award-open").click(function(){$("#amy-award-intro").slideUp("250",function(){$("#amy-award-start").slideDown("350"),$("html, body").animate({scrollTop:$("#amy-award-start").offset().top},750),$("input[name='amy_giver']").focus()})}),$("#js-amy-award-cancel").click(function(){return $("#amy-award-start").slideUp("250",function(){$("#amy-award-intro").slideDown("350",function(){$("html, body").animate({scrollTop:$("body").offset().top},750)})}),!1}),$("#js-amy-award-values input[type=checkbox]").on("change",function(){$("input[type=checkbox]:checked").length>3&&$(this).prop("checked",!1)}),$("#amy-award-form").submit(a)});
